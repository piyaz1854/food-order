// ui.js
// Визуальные штуки: статистика, подсветка, динамические блоки
...
const FoodUI = (() => {
  ...
  // ❗ новый метод — убрать подсветку дорогих
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ❗ ВАЖНО: Больше НЕ вызываем markExpensiveDishes здесь
  // Подсветка дорогих будет только через Bling checkbox
});
